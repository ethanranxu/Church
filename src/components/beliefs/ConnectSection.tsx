    ...
    return (
        <div className="bg-[#1E88E5] py-12 px-4 md:px-10">
            <div className="max-w-[1280px] w-full mx-auto flex flex-col items-center">
                <h3 className="text-white text-3xl font-bold mb-4 tracking-wide">{t.beliefs.connect.title}</h3>
                <p className="text-blue-100 text-sm mb-8 text-center">{t.beliefs.connect.description}</p>
