...
const ChurchCard = ({ church, labels }: { church: ChurchInfo; labels: { establishedDate: string; meetingTime: string; contactInfo: string; meetingLocation: string } }) => (
    <div className="bg-white dark:bg-[#1a2632] rounded-2xl overflow-hidden shadow-sm border border-gray-100 dark:border-gray-800 hover:shadow-lg transition-all duration-300">
        ...
        <div className="p-6">
            ...
            <div className="flex items-start justify-between gap-4 mb-6">
                <div className="flex-1 space-y-3">
                    ...
                    <div className="flex items-start gap-3">
                        ...
                        <div>
                            <span className="text-xs text-gray-400 dark:text-gray-500 block mb-0.5">{labels.establishedDate}</span>
                    ...
                    <div className="flex items-start gap-3">
                        ...
                        <div>
                            <span className="text-xs text-gray-400 dark:text-gray-500 block mb-0.5">{labels.meetingTime}</span>
                    ...
                    <div className="flex items-start gap-3">
                        ...
                        <div>
                            <span className="text-xs text-gray-400 dark:text-gray-500 block mb-0.5">{labels.contactInfo}</span>
            ...
            <div className="flex items-start gap-3">
                ...
                <div>
                    <span className="text-xs text-gray-400 dark:text-gray-500 block mb-0.5">{labels.meetingLocation}</span>
...
export default function ChurchPlanting() {
    ...
    const churches: ChurchInfo[] = [
        {
            name: t.nav.hibiscusCoast,
            logo: '/images/hibiscus-coast-church-logo.png',
            photo: '/images/hibiscus-coast-church.jpg',
            establishedDate: '2016/3/6',
            location: 'Kingsway Senior Campus, 100 Jelas Road, Red Beach',
            meetingTime: t.hibiscusCoast.meeting.timeDesc + ' 9:30AM',
            contacts: [
                { name: t.ministry.pastoralTeam.pastorKungName, phone: '022 476 9930' }
            ],
            href: '/hibiscus-coast'
        },
        {
            ...
            establishedDate: '2019/6/2',
            location: '168 Deep Creek Road, Torbay (St Mary By The Sea)',
            meetingTime: t.longBay.meeting.timeDesc + ' 2:30PM',
            contacts: [
                { name: t.ministry.pastoralTeam.pastorKungName, phone: '022 476 9930' },
                { name: t.ministry.pastoralTeam.pastorNiName, phone: '027 558 4493' }
            ],
            href: '/long-bay'
        }
    ];
    ...
    const labels = {
        establishedDate: t.beliefs.churchPlanting.establishedDate,
        meetingTime: t.beliefs.churchPlanting.meetingTime,
        contactInfo: t.beliefs.churchPlanting.contactInfo,
        meetingLocation: t.beliefs.churchPlanting.meetingLocation,
    };
            ...
            <div className="max-w-[1140px] w-full mx-auto">
                <div className="text-center mb-16">
                    <h2 className="text-3xl md:text-4xl font-bold text-[#111418] dark:text-white mb-4">
                        {t.beliefs.churchPlanting.title}
                    </h2>
                    <div className="w-12 h-1 bg-[#FBBF24] mx-auto mb-6"></div>
                    <p className="text-gray-600 dark:text-gray-400 max-w-2xl mx-auto">
                        {t.beliefs.churchPlanting.subtitle}
                    </p>
                </div>

                <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                    {churches.map((church, index) => (
                        <ChurchCard key={index} church={church} labels={labels} />
                    ))}
                </div>
            </div>
        </div>
